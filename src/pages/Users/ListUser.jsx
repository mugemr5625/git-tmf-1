...
import { Button, notification, Grid, List, Avatar, Dropdown, Menu, Modal, Badge, Divider, Skeleton, Select, Switch, FloatButton } from "antd"; 
...
import { EllipsisOutlined, SearchOutlined, ReloadOutlined, PlusOutlined, CaretDownOutlined } from "@ant-design/icons"; 
          ...
          {showReset && searchText && (
            <div className="list-user-search-results">
              <span className="list-user-search-label">
                Search Results:{" "}
                <span className="list-user-search-query">
                  "{searchText}"
                </span>
              </span>
